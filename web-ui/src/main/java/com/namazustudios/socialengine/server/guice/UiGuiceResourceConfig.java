 ...
 */
public class UiGuiceResourceConfig extends ResourceConfig {

    private static final Logger logger = LoggerFactory.getLogger(UiGuiceResourceConfig.class);

    public static final String INJECOR_ATTRIBUTE_NAME = UiGuiceResourceConfig.class.getName() + ".Injector";

    @Inject
    public UiGuiceResourceConfig(ServiceLocator serviceLocator, ServletContext context) {

        packages(true, "com.namazustudios.socialengine.model");
        packages(false, "com.namazustudios.socialengine.server");
