...
import com.namazustudios.socialengine.client.rest.client.internal.FacebookApplicationConfigurationClient;
...
import static com.namazustudios.socialengine.client.controlpanel.view.application.FacebookApplicationConfigurationEditorPresenter.Param.configuration_id;

/**
 * Created by patricktwohig on 6/16/17.
 */
public class FacebookApplicationConfigurationEditorPresenter extends Presenter<
        FacebookApplicationConfigurationEditorPresenter.MyView,
        FacebookApplicationConfigurationEditorPresenter.MyProxy> {
    ...
    @Inject
    public FacebookApplicationConfigurationEditorPresenter(EventBus eventBus, MyView view, MyProxy proxy) {
