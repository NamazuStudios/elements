...
import dev.getelements.elements.rt.transact.RevisionDataStore.LockedRevision;
import dev.getelements.elements.rt.transact.unix.UnixFSCircularBlockBuffer.Slice;
import dev.getelements.elements.rt.transact.unix.UnixFSCircularBlockBuffer.View;
...
import static dev.getelements.elements.rt.transact.unix.UnixFSRevisionTableEntry.State.COMMITTED;
...
public class UnixFSRevisionTable {
    ...
    public static final String UNIXFS_REVISION_TABLE_COUNT = "dev.getelements.elements.rt.transact.unix.fs.revision.table.count";
