...
import static dev.getelements.elements.rt.util.Hex.encode;
...
public class UnixFSReversePathMapping {
    ...
    /**
     * Resolves the link name of the s {@link dev.getelements.elements.rt.Path} against the FS Path..
     *
     * @param fsPath {@link Path}
     * @param rtPath the {@link dev.getelements.elements.rt.Path}
     * @return the a {@link Path} with the name.
     */
    public Path resolvePath(final Path fsPath, final dev.getelements.elements.rt.Path rtPath) {
