...
import static dev.getelements.elements.rt.id.ResourceId.resourceIdFromByteBuffer;
...
public class UnixFSTransactionParameter {
    ...
    /**
     * Returns this parameter as an instance {@link dev.getelements.elements.rt.Path} or throws an instance of
     * {@link UnixFSProgramCorruptionException} if the type is not properly matched.
     *
     * @return a {@link dev.getelements.elements.rt.Path}
     */
    public dev.getelements.elements.rt.Path asRTPath() {
        try {
    ...
    public enum Type {
        ...
        /**
         * Represents a {@link dev.getelements.elements.rt.Path}
         */
        RT_PATH {
            @Override
            protected dev.getelements.elements.rt.Path asRTPath(final UnixFSTransactionParameter param) {
                ...
                return dev.getelements.elements.rt.Path.fromPathString(pathString);
        ...
        protected dev.getelements.elements.rt.Path asRTPath(UnixFSTransactionParameter unixFSTransactionParameter) {
            return badType(dev.getelements.elements.rt.Path.class);
        }
