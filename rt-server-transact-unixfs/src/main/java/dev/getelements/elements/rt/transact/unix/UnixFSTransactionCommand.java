...
public class UnixFSTransactionCommand {
    ...
    public static class Builder {
        ...
        /**
         * Appends a {@link dev.getelements.elements.rt.Path} parameter.
         *
         * @param path the {@link dev.getelements.elements.rt.Path} parameter
         *
         * @return this instance
         */
        public Builder addRTPathParameter(final dev.getelements.elements.rt.Path path) {
            if (parameterOperations.size() >= Short.MAX_VALUE) throw new InternalException("Exceeded parameter count");
