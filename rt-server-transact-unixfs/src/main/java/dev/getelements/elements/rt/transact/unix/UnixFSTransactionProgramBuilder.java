...
public class UnixFSTransactionProgramBuilder {
    ...
    /**
     * Adds a step to the program to unlink a {@link dev.getelements.elements.rt.Path} from the revision store.
     *
     * @param executionPhase  the execution phase to use
     * @param rtPath the {@link dev.getelements.elements.rt.Path} to unlink
     * @return this instance
     */
    ...
    /**
     * Links a {@link ResourceId} to a specific {@link dev.getelements.elements.rt.Path}.
     *
     * @param executionPhase  the execution phase to use
     * @param resourceId the {@link ResourceId} to link
     * @param rtPath the {@link dev.getelements.elements.rt.Path} to link
     * @return this instance
     */
