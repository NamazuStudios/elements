...
public class UpdateBuilder {
    ...
    /**
     * Builds the {@link Modify <ModelT>} from the supplied {@link Query<ModelT>}.
     *
     * @param query the {@link Query<ModelT>}
     * @param <ModelT> the model type to update
     * @return an instance of {@link Modify<ModelT>} with the updates supplied by this builder
     *
    ...
    /**
     * Equivalent to invoking {@link #modify(Query<ModelT>)} (Query)}.{@link Modify#execute(ModifyOptions)}
     * @param query the {@link Query<ModelT>} against which to apply the updates
     *
     * @return the {@link UpdateResult}
     */
