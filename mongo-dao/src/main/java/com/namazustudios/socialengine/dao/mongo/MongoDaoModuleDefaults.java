...
import static com.namazustudios.socialengine.dao.mongo.provider.MongoClientProvider.MONGO_MAX_CONNECTIONS;
import static com.namazustudios.socialengine.dao.mongo.provider.MongoClientProvider.MONGO_MIN_CONNECTIONS;
...
public class MongoDaoModuleDefaults implements ModuleDefaults {
    ...
    public static final int DEFAULT_MIN_CONNECTIONS = 10;
    ...
    public Properties get() {
        ...
        defaultProperties.setProperty(MONGO_MIN_CONNECTIONS, Integer.toString(DEFAULT_MIN_CONNECTIONS));
        defaultProperties.setProperty(MONGO_MAX_CONNECTIONS, Integer.toString(DEFAULT_MAX_CONNECTIONS));
