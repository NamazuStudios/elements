 ...
 */
public class MinaBestEffortClientModule extends MinaModule {
    ...
    protected void configureMINA() {
        ...
        binder().bind(OutgoingNetworkOperations.class).to(BestEffortIOSessionOutgoingNetworkOperations.class);
