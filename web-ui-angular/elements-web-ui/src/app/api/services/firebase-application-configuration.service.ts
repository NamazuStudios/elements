...
import { GameOnApplicationConfiguration } from '../models/game-on-application-configuration';
@Injectable({
  providedIn: 'root',
})
class FirebaseApplicationConfigurationService extends BaseService {
  ...
  /**
   * Gets a single GameOn application based on unique name or ID.
   * @param params The `FirebaseApplicationConfigurationService.GetGameOnApplicationConfigurationParams` containing the following parameters:
   *
   * - `applicationNameOrId`:
   *
   * - `applicationConfigurationNameOrId`:
   ...
   * @return successful operation
   */
  getGameOnApplicationConfigurationResponse(params: FirebaseApplicationConfigurationService.GetGameOnApplicationConfigurationParams): Observable<StrictHttpResponse<GameOnApplicationConfiguration>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/application/${params.applicationNameOrId}/configuration/game_on/${params.applicationConfigurationNameOrId}`,
      __body,
      {
        headers: __headers,
        params: __params,
    ...
    return this.http.request<any>(req).pipe(
      __filter(_r => _r instanceof HttpResponse),
      __map((_r: HttpResponse<any>) => {
        return _r as StrictHttpResponse<GameOnApplicationConfiguration>;
      })
    );
  }
   ...
   * @return successful operation
   */
  getGameOnApplicationConfiguration(params: FirebaseApplicationConfigurationService.GetGameOnApplicationConfigurationParams): Observable<GameOnApplicationConfiguration> {
    return this.getGameOnApplicationConfigurationResponse(params).pipe(
      __map(_r => _r.body)
    );
  }

  /**
   * Updates an existing GameOn Application profile if it is known to the server.
   * @param params The `FirebaseApplicationConfigurationService.UpdateApplicationConfiguration_1Params` containing the following parameters:
   *
   * - `applicationNameOrId`:
   *
   * - `applicationConfigurationNameOrId`:
   ...
   * @return successful operation
   */
  updateApplicationConfiguration_1Response(params: FirebaseApplicationConfigurationService.UpdateApplicationConfiguration_1Params): Observable<StrictHttpResponse<GameOnApplicationConfiguration>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * @return successful operation
   */
  updateApplicationConfiguration_1(params: FirebaseApplicationConfigurationService.UpdateApplicationConfiguration_1Params): Observable<GameOnApplicationConfiguration> {
    return this.updateApplicationConfiguration_1Response(params).pipe(
      __map(_r => _r.body)
    );
  }

  /**
   * Deletes an existing GameOn Application profile if it is known to the server.
   * @param params The `FirebaseApplicationConfigurationService.DeleteGameOnApplicationConfigurationParams` containing the following parameters:
   *
   * - `applicationNameOrId`:
   *
   * - `applicationConfigurationNameOrId`:
   */
  deleteGameOnApplicationConfigurationResponse(params: FirebaseApplicationConfigurationService.DeleteGameOnApplicationConfigurationParams): Observable<StrictHttpResponse<void>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * - `applicationConfigurationNameOrId`:
   */
  deleteGameOnApplicationConfiguration(params: FirebaseApplicationConfigurationService.DeleteGameOnApplicationConfigurationParams): Observable<void> {
    return this.deleteGameOnApplicationConfigurationResponse(params).pipe(
      __map(_r => _r.body)
    );
  }

  /**
   * Creates a new GameOn ApplicationConfiguration with the specific ID or application.
   * @param params The `FirebaseApplicationConfigurationService.CreateGameOnApplicationConfigurationParams` containing the following parameters:
   *
   * - `applicationNameOrId`:
   *
   * - `body`:
   ...
   * @return successful operation
   */
  createGameOnApplicationConfigurationResponse(params: FirebaseApplicationConfigurationService.CreateGameOnApplicationConfigurationParams): Observable<StrictHttpResponse<GameOnApplicationConfiguration>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/application/${params.applicationNameOrId}/configuration/game_on`,
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @return successful operation
   */
  createGameOnApplicationConfiguration(params: FirebaseApplicationConfigurationService.CreateGameOnApplicationConfigurationParams): Observable<GameOnApplicationConfiguration> {
    return this.createGameOnApplicationConfigurationResponse(params).pipe(
      __map(_r => _r.body)
    );
  }
}
...
module FirebaseApplicationConfigurationService {
  ...
  /**
   * Parameters for getGameOnApplicationConfiguration
   */
  export interface GetGameOnApplicationConfigurationParams {
    applicationNameOrId: string;
    applicationConfigurationNameOrId: string;
  }

  /**
   * Parameters for updateApplicationConfiguration_1
   */
  export interface UpdateApplicationConfiguration_1Params {
    applicationNameOrId: string;
    applicationConfigurationNameOrId: string;
    body?: GameOnApplicationConfiguration;
  }

  /**
   * Parameters for deleteGameOnApplicationConfiguration
   */
  export interface DeleteGameOnApplicationConfigurationParams {
    applicationNameOrId: string;
    applicationConfigurationNameOrId: string;
  }

  /**
   * Parameters for createGameOnApplicationConfiguration
   */
  export interface CreateGameOnApplicationConfigurationParams {
    applicationNameOrId: string;
    body?: GameOnApplicationConfiguration;
  }
}
