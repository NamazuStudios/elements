...
/**
 * Corresponds to the GameOn Claim Prize List Request:  https://developer.amazon.com/docs/gameon/game-api-ref.html#claimprizelistrequest
 */
export interface GameOnClaimPrizeListRequest {
