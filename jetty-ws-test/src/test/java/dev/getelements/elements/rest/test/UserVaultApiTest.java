...
import dev.getelements.elements.rest.test.model.VaultPagination;
...
import static dev.getelements.elements.sdk.service.blockchain.VaultService.DEFAULT_VAULT_ALGORITHM;
...
public class UserVaultApiTest {
    ...
    public Object[] getTests() {
        return new Object[] {
                TestUtils.getInstance().getTestFixture(UserVaultApiTest.class)
        };
    }
