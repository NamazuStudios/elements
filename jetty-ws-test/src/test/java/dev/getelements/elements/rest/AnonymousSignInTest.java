...
import static dev.getelements.elements.rest.ClientContext.DUMMY_PASSWORD;
...
public class AnonymousSignInTest {
    ...
    public Object[] getTests() {
        return new Object[] {
                TestUtils.getInstance().getXodusTest(AnonymousSignInTest.class),
                TestUtils.getInstance().getUnixFSTest(AnonymousSignInTest.class)
        };
    }
