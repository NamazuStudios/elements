...
import dev.getelements.elements.sdk.model.util.PaginationWalker.WalkFunction;
...
public class UserDistinctInventoryItemApiTest {
    ...
    public Object[] getTests() {
        return new Object[] {
                TestUtils.getInstance().getTestFixture(UserDistinctInventoryItemApiTest.class)
        };
    }
