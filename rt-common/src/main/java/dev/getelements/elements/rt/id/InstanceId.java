package dev.getelements.elements.rt.id;

import dev.getelements.elements.rt.annotation.Public;
import dev.getelements.elements.rt.exception.InternalException;
import dev.getelements.elements.rt.exception.InvalidInstanceIdException;

import java.io.*;
import java.nio.file.StandardCopyOption;
import java.util.UUID;

import static dev.getelements.elements.rt.id.V1CompoundId.Builder;
import static dev.getelements.elements.rt.id.V1CompoundId.Field.*;
