...
public interface IndexContext {
     ...
     *
     * The supplied {@link List} should represent a complete buffering of all {@link Listing} instances
     * matching the {@link Path}.
     *
     * @param path the {@link Path} to match
     * @param success a {@link Consumer} which receives an instance of {@link Listing}
     * @param failure a {@link Consumer} which receives an exception indicating a failure reason.
     */
     ...
     * @param resourceId the source {@link ResourceId} to link
     * @param destination the {@link Path} of the destination to link
     * @param success a {@link Consumer} which will be called on successful completion
     * @param failure a {@link Consumer} which will be called on a failure
     */
