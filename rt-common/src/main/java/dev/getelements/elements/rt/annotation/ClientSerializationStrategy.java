...
public @interface ClientSerializationStrategy {
     ...
     */
    String APPLE_ITUNES = "dev.getelements.elements.annotation.SerializationStrategy.apple.itunes";

    /**
     * Implies that serialized fields use lowerCamelCase
     */
    String LCAMEL = "dev.getelements.elements.annotation.SerializationStrategy.lcamel";
