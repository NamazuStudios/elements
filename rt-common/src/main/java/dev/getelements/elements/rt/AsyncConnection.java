 ...
 * {@link AsyncConnection} aren't thread-safe. Therefore you must ensure that all manipulation of
 * the {@link AsyncConnection} instance is performed within a callback from the subscribed events.
 */
public interface AsyncConnection<ContextT, SocketT> extends Connection<ContextT, SocketT> {
    ...
    /**
     * Returns this {@link AsyncConnection}.  This hints to the underlying
     * {@link AsyncConnectionService} that the client code is done using the connection.  Depending
     ...
     *
     * @param asyncConnectionConsumer the {@link Consumer} to receive the event
     * @return {@link Subscription}
     */
     ...
     *
     * @param pooledAsyncConnectionConsumer the {@link Consumer} to receive the event.
     *
