...
import static dev.getelements.elements.rt.annotation.Dispatch.Type;
...
public interface RemoteInvoker {
     ...
     */
    String REMOTE_INVOKER_MIN_CONNECTIONS = "dev.getelements.elements.rt.remote.RemoteInvoker.minConnections";

    /**
     * The maximum underlying connections to maintain.
     */
    String REMOTE_INVOKER_MAX_CONNECTIONS = "dev.getelements.elements.rt.remote.RemoteInvoker.maxConnections";
