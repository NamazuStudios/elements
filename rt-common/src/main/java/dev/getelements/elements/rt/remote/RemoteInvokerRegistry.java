...
public interface RemoteInvokerRegistry {
     ...
     * @param deploymentId
     */
    List<RemoteInvokerStatus> getAllRemoteInvokerStatuses(DeploymentId deploymentId);
     ...
     * @param deploymentId
     */
    default List<RemoteInvoker> getAllRemoteInvokers(final DeploymentId deploymentId) {
        return getAllRemoteInvokerStatuses(deploymentId)
            .stream()
     ...
     * @param deploymentId
     */
    default RemoteInvoker getBestRemoteInvoker(final DeploymentId deploymentId) {
        return getBestRemoteInvokerStatus(deploymentId).getInvoker();
    }
     ...
     * @param deploymentId
     */
    RemoteInvokerStatus getBestRemoteInvokerStatus(final DeploymentId deploymentId);
