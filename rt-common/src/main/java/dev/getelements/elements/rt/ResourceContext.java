...
import dev.getelements.elements.rt.routing.BroadcastRoutingStrategy;
...
public interface ResourceContext {
     ...
     *
     * @param success the {@link Consumer} which will be called if the call succeeds
     * @param failure the {@link Consumer} which will be called if the call fails, capturing any failure
