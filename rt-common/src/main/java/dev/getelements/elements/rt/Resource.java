...
import dev.getelements.elements.rt.exception.ResourceDestroyedException;
...
import static dev.getelements.elements.rt.util.OutputStreamAdapter.FLUSH;
...
public interface Resource extends AutoCloseable {
     ...
     *
     * @throws MethodNotFoundException if the method cannot be found
     */
     ...
     * {@link InputStream} was produced by a call to {@link #serialize(OutputStream)}.
     *
     * @param ibc the {@link InputStream} from which to read the serialized resource
     * @throws IOException if something failed during deserialization
     */
