...
public interface LocalInvocationProcessor {
     ...
     * the result to the supplied {@link Consumer}.  This should not throw an exception, ever.
     * @param target
     * @param invocation
     ...
     * {@link Consumer<InvocationError>} or the {@link Consumer}
     */
    @FunctionalInterface
    ...
    /**
     * Constructs a {@link ReturnValueStrategy} which ignores the return value and immediately returns an
    ...
    /**
     * Constructs a {@link ReturnValueStrategy} which simply hands the result of the {@link Invocation}
