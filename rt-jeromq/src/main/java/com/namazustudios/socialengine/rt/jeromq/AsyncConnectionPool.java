...
//
//    /**
//     * Gets an instance of {@link PooledAsyncConnection}, blocking until one becomes available.  The supplied
//     * {@link Consumer< PooledAsyncConnection >} will be called on a background thread which will be used to process the
//     * connection.  For the lifecycle of the {@link PooledAsyncConnection}, the same thread will be used to execute all
//     * callbacks.
//     */
