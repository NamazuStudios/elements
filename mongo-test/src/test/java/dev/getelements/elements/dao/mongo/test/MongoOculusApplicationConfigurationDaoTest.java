...
public class MongoOculusApplicationConfigurationDaoTest extends MongoApplicationConfigurationDaoTest<OculusApplicationConfiguration> {
    ...
    @Override
    protected Class<OculusApplicationConfiguration> getTestType() {
        return OculusApplicationConfiguration.class;
    }

    @Override
    protected OculusApplicationConfiguration createTestObject() {
    ...
    protected void assertCreatedCorrectly(
            final OculusApplicationConfiguration actual,
            final OculusApplicationConfiguration expected) {
    ...
    public void testUpdateProductBundles(
            ...
            final OculusApplicationConfiguration intermediate) {
