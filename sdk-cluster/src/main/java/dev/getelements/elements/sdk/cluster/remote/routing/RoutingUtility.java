...
import dev.getelements.elements.sdk.cluster.remote.exception.RoutingException;
...
public interface RoutingUtility {
    ...
    /**
     * Ensures that the following {@link List<Object>} can be reduced to a single {@link NodeId}, throwing the
