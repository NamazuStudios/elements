...
public class ResourceId implements Serializable, HasNodeId, HasCompoundId<V1CompoundId>  {
    ...
    /**
     * Writes this {@link ResourceId} to a {@link ByteBuffer} at the supplied position. As the position is specified,
     ...
     * {@link ResourceId} that will never match an actual Resource in the cluster. This is useful for making
    ...
    /**
     * Reads a {@link ResourceId} from the supplied {@link ByteBuffer} and position, ensuring that the buffer's mark, limit,
     ...
     * @return the {@link ResourceId} instance
     */
    public static ResourceId resourceIdFromByteBuffer(
