...
export class SchedulesService extends BaseService {
   ...
   * @param params The 'MissionsServce.GetSchedulesParams' containing the following parameters:
   *
   * - 'tags':
   *
   * - 'search':
   ...
   */
  getMissionsResponse(params: MissionsService.GetSchedulesParams): Observable<StrictHttpResponse<PaginationItem>> {
   ...
   * @param params The `MissionsService.GetSchedulesParams` containing the following parameters:
   *
   * - `tags`:
   *
   * - `search`:
   ...
   * @return successful operation
   */
  getMissions(params: MissionsService.GetSchedulesParams): Observable<PaginationItem> {
   ...
   * @param params The `MissionsService.UpdateScheduleParams` containing the following parameters:
   *
   * - `identifier`:
   *
   * - `body`:
   ...
   * @return successful operation
   */
  updateMissionResponse(params: MissionsService.UpdateScheduleParams): Observable<StrictHttpResponse<Item>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * @return successful operation
   */
  updateMission(params: MissionsService.UpdateScheduleParams): Observable<Item> {
