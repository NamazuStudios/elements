...
import {ItemExistsValidator} from '../../../digital-goods/item-exists-validator';
...
export class MissionRewardsEditorComponent implements OnInit {
  ...
  updateRewardQuantity(reward: Reward, newQuantity: number) {
    reward.quantity = newQuantity;
  }

  updateRewardItem(reward: Reward, itemName: string) {
