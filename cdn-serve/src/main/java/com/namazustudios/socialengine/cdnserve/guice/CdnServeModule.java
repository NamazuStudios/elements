...
public class CdnServeModule extends AbstractModule {

    private final Supplier<Properties> configurationSupplier;

    public CdnServeModule(final Supplier<Properties> configurationSupplier) {
    ...
    protected void configure() {
        ...
        install(new FileSystemCdnServeModule());
    }
}
