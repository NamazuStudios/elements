...
import com.namazustudios.socialengine.jnlua.NamedJavaFunction;
...
public class LuaStateErrorTest extends AbstractLuaTest {
	...
	public void testIllegalCompareLt() {
		...
		luaState.pushNil();
		luaState.compare(1, 2, LuaState.RelOperator.LT);
	}
	...
	public void testIllegalCompareLe() {
		luaState.pushNumber(1);
		luaState.pushNil();
		luaState.compare(1, 2, LuaState.RelOperator.LE);
	}
	...
	public void testUnderflowArith1() {
		luaState.arith(LuaState.ArithOperator.ADD);
	}
	...
	public void testUnderflowArith3() {
		luaState.arith(LuaState.ArithOperator.UNM);
	}
	...
	public void testNullCheckEnum1() {
		luaState.pushString("");
		luaState.checkEnum(1, (LuaState.GcAction[]) null);
	}
	...
	public void testNullCheckEnum2() {
		luaState.pushString("");
		luaState.checkEnum(1, null, LuaState.GcAction.STOP);
	}
	...
	public void testIllegalCheckEnum1() {
		luaState.pushBoolean(false);
		luaState.checkEnum(1, LuaState.GcAction.values());
	}
	...
	public void testIllegalCheckEnum2() {
		luaState.pushBoolean(false);
		luaState.checkEnum(1, LuaState.GcAction.values(), LuaState.GcAction.STOP);
	}
