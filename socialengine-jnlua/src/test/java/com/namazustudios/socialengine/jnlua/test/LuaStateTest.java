...
public class LuaStateTest extends AbstractLuaTest {
	...
	public void testRegistryIndex() {
		...
		Assert.assertEquals(LuaType.TABLE, luaState.type(-1));
		luaState.pop(1);
	...
	public void testGc() throws Exception {
		Assert.assertEquals(-1, luaState.gc(LuaState.GcAction.ISRUNNING, 0));
		Assert.assertEquals(0, luaState.gc(LuaState.GcAction.STOP, 0));
		Assert.assertEquals(-1, luaState.gc(LuaState.GcAction.ISRUNNING, 0));
		Assert.assertEquals(0, luaState.gc(LuaState.GcAction.RESTART, 0));
		Assert.assertEquals(-1, luaState.gc(LuaState.GcAction.ISRUNNING, 0));
		Assert.assertEquals(0, luaState.gc(LuaState.GcAction.COLLECT, 0));
		assertTrue((long) luaState.gc(LuaState.GcAction.COUNT, 0) * 1024 + luaState.gc(LuaState.GcAction.COUNTB, 0) > 0);
		Assert.assertEquals(0, luaState.gc(LuaState.GcAction.STEP, 0));
	...
	public void testRegister() throws Exception {
		...
		Assert.assertEquals(LuaType.FUNCTION, luaState.type(-1));
		luaState.pop(1);
	...
	public void testLoad() throws Exception {
		...
		Assert.assertEquals(LuaType.NUMBER, luaState.type(-1));
		luaState.pop(1);
	...
	public void testCall() throws Exception {
		...
		luaState.pushInteger(1);
		luaState.call(2, 1);
		Assert.assertEquals(2, luaState.toInteger(-1));
		luaState.pop(1);
	...
	public void testPushBoolean() throws Exception {
		...
		Assert.assertEquals(LuaType.BOOLEAN, luaState.type(1));
		Assert.assertEquals(true, luaState.toBoolean(1));
		luaState.pop(1);
	...
	public void testPushByteArray() throws Exception {
		...
		Assert.assertEquals(LuaType.STRING, luaState.type(1));
		Assert.assertArrayEquals(new byte[] { 0, 0 }, luaState.toByteArray(1));
		luaState.pop(1);
	...
	public void testPushJavaObject() throws Exception {
		...
		Assert.assertEquals(LuaType.NIL, luaState.type(1));
		assertNull(luaState.toJavaObject(1, Object.class));
		luaState.pop(1);

		luaState.pushJavaObject(Boolean.FALSE);
		Assert.assertEquals(LuaType.BOOLEAN, luaState.type(1));
		Assert.assertEquals(Boolean.FALSE, luaState.toJavaObject(1, Boolean.class));
		luaState.pop(1);
		...
		Assert.assertEquals(LuaType.STRING, luaState.type(1));
		Assert.assertEquals("test", luaState.toJavaObject(1, String.class));
		luaState.pop(1);
	...
	public void testPushJavaObjectRaw() throws Exception {
		...
		Assert.assertEquals(LuaType.USERDATA, luaState.type(1));
	...
	public void testPushNumber() throws Exception {
		...
		Assert.assertEquals(LuaType.NUMBER, luaState.type(1));
		Assert.assertEquals(1.0, luaState.toNumber(1), 0.0);
		luaState.pop(1);
	...
	public void testPushString() throws Exception {
		...
		Assert.assertEquals(LuaType.STRING, luaState.type(1));
		Assert.assertEquals("test", luaState.toString(1));
		luaState.pop(1);
	}
			...
			for (int j = 1; j <= 10; j++) {
				if (i == j) {
					assertTrue(String.format("%d, %d", i, j),
							luaState.compare(i, j, LuaState.RelOperator.EQ));
				} else {
		...
		for (int i = 0; i < 3; i++) {
			for (int j = 0; j < 3; j++) {
				Assert.assertEquals(i == j,
						luaState.compare(i - 3, j - 3, LuaState.RelOperator.EQ));
			}
		}
		for (int i = 0; i < 3; i++) {
			for (int j = 0; j < 3; j++) {
				Assert.assertEquals(i < j,
						luaState.compare(i - 3, j - 3, LuaState.RelOperator.LT));
			}
		}
		for (int i = 0; i < 3; i++) {
			for (int j = 0; j < 3; j++) {
				Assert.assertEquals(i <= j,
						luaState.compare(i - 3, j - 3, LuaState.RelOperator.LE));
			}
		}
		assertFalse(luaState.compare(20, 21, LuaState.RelOperator.EQ));
		assertFalse(luaState.compare(1, 21, LuaState.RelOperator.EQ));
		assertFalse(luaState.compare(20, 1, LuaState.RelOperator.EQ));
	...
	public void testRawLen() throws Exception {
		...
		// Test
		Assert.assertEquals(0, luaState.rawLen(1));
		Assert.assertEquals(0, luaState.rawLen(2));
		Assert.assertEquals(0, luaState.rawLen(3));
		Assert.assertEquals(4, luaState.rawLen(4));
		Assert.assertEquals(1, luaState.rawLen(5));
		Assert.assertEquals(1, luaState.rawLen(6));
		Assert.assertEquals(0, luaState.rawLen(7));
		assertTrue(luaState.rawLen(8) == 4 || luaState.rawLen(8) == 8);
		Assert.assertEquals(0, luaState.rawLen(9));
		Assert.assertEquals(0, luaState.rawLen(10));
	...
	public void testToByteArray() throws Exception {
		...
		Assert.assertArrayEquals(new byte[] { '1', '.', '0'}, luaState.toByteArray(3));
		Assert.assertArrayEquals(new byte[] { 't', 'e', 's', 't' },
				luaState.toByteArray(4));
		Assert.assertArrayEquals(new byte[] { '1' }, luaState.toByteArray(5));
	...
	public void testToInteger() throws Exception {
		...
		// Test
		Assert.assertEquals(0, luaState.toInteger(1));
		Assert.assertEquals(0, luaState.toInteger(2));
		Assert.assertEquals(1, luaState.toInteger(3));
		Assert.assertEquals(0, luaState.toInteger(4));
		Assert.assertEquals(1, luaState.toInteger(5));
		Assert.assertEquals(0, luaState.toInteger(6));
		Assert.assertEquals(0, luaState.toInteger(7));
		Assert.assertEquals(0, luaState.toInteger(8));
		Assert.assertEquals(0, luaState.toInteger(9));
		Assert.assertEquals(0, luaState.toInteger(10));
	...
	public void testToIntegerX() throws Exception {
		...
		Assert.assertEquals(Integer.valueOf(1), luaState.toIntegerX(3));
		assertNull(luaState.toIntegerX(4));
		Assert.assertEquals(Integer.valueOf(1), luaState.toIntegerX(5));
	...
	public void testToJavaObject() throws Exception {
		...
		// Test
		assertNull(luaState.toJavaObject(1, Object.class));
		Assert.assertEquals(Boolean.FALSE, luaState.toJavaObject(2, Boolean.class));
		Assert.assertEquals(Double.valueOf(1.0),
				luaState.toJavaObject(3, Double.class));
		Assert.assertEquals("test", luaState.toJavaObject(4, String.class));
		Assert.assertEquals("1", luaState.toJavaObject(5, String.class));
	...
	public void testToNumber() throws Exception {
		...
		// Test
		Assert.assertEquals(0.0, luaState.toNumber(1), 0.0);
		Assert.assertEquals(0.0, luaState.toNumber(2), 0.0);
		Assert.assertEquals(1.0, luaState.toNumber(3), 0.0);
		Assert.assertEquals(0.0, luaState.toNumber(4), 0.0);
		Assert.assertEquals(1.0, luaState.toNumber(5), 0.0);
		Assert.assertEquals(0.0, luaState.toNumber(6), 0.0);
		Assert.assertEquals(0.0, luaState.toNumber(7), 0.0);
		Assert.assertEquals(0.0, luaState.toNumber(8), 0.0);
		Assert.assertEquals(0.0, luaState.toNumber(9), 0.0);
		Assert.assertEquals(0.0, luaState.toNumber(10), 0.0);
	...
	public void testToNumberX() throws Exception {
		...
		Assert.assertEquals(Double.valueOf(1.0), luaState.toNumberX(3));
		assertNull(luaState.toNumberX(4));
		Assert.assertEquals(Double.valueOf(1.0), luaState.toNumberX(5));
	...
	public void testToPointer() throws Exception {
		...
		// Test
		Assert.assertEquals(0L, luaState.toPointer(1));
		Assert.assertEquals(0L, luaState.toPointer(2));
		Assert.assertEquals(0L, luaState.toPointer(3));
		Assert.assertEquals(0L, luaState.toPointer(4));
		Assert.assertEquals(0L, luaState.toPointer(5));
	...
	public void testToString() throws Exception {
		...
		Assert.assertEquals("1.0", luaState.toString(3));
		Assert.assertEquals("test", luaState.toString(4));
		Assert.assertEquals("1", luaState.toString(5));
		assertNull(luaState.toString(6));
		assertNull(luaState.toString(7));
		assertNull(luaState.toString(8));
		assertNull(luaState.toString(9));
	...
	public void testType() throws Exception {
		...
		// Test
		Assert.assertEquals(LuaType.NIL, luaState.type(1));
		Assert.assertEquals(LuaType.BOOLEAN, luaState.type(2));
		Assert.assertEquals(LuaType.NUMBER, luaState.type(3));
		Assert.assertEquals(LuaType.STRING, luaState.type(4));
		Assert.assertEquals(LuaType.STRING, luaState.type(5));
		Assert.assertEquals(LuaType.TABLE, luaState.type(6));
		Assert.assertEquals(LuaType.FUNCTION, luaState.type(7));
		Assert.assertEquals(LuaType.USERDATA, luaState.type(8));
		Assert.assertEquals(LuaType.FUNCTION, luaState.type(9));
		Assert.assertEquals(LuaType.FUNCTION, luaState.type(10));
	...
	public void testTypeName() throws Exception {
		...
		// Test
		Assert.assertEquals("nil", luaState.typeName(1));
		Assert.assertEquals("boolean", luaState.typeName(2));
		Assert.assertEquals("number", luaState.typeName(3));
		Assert.assertEquals("string", luaState.typeName(4));
		Assert.assertEquals("string", luaState.typeName(5));
		Assert.assertEquals("table", luaState.typeName(6));
		Assert.assertEquals("function", luaState.typeName(7));
		Assert.assertEquals("java.lang.Object", luaState.typeName(8));
		Assert.assertEquals("function", luaState.typeName(9));
		Assert.assertEquals("function", luaState.typeName(10));
		Assert.assertEquals("none", luaState.typeName(11));
	...
	public void testAbsIndex() throws Exception {
		luaState.pushInteger(0);
		Assert.assertEquals(1, luaState.absIndex(1));
		Assert.assertEquals(1, luaState.absIndex(-1));
		Assert.assertEquals(100, luaState.absIndex(100));
		Assert.assertEquals(-98, luaState.absIndex(-100));
	...
	public void testArith() throws Exception {
		testArith(1, Integer.valueOf(2), LuaState.ArithOperator.ADD, 3);
		testArith(1, Integer.valueOf(2), LuaState.ArithOperator.SUB, -1);
		testArith(2, Integer.valueOf(3), LuaState.ArithOperator.MUL, 6);
		testArith(10, Integer.valueOf(2), LuaState.ArithOperator.DIV, 5);
		testArith(17, Integer.valueOf(5), LuaState.ArithOperator.MOD, 2);
		testArith(3, Integer.valueOf(2), LuaState.ArithOperator.POW, 9);
		testArith(7, null, LuaState.ArithOperator.UNM, -7);
	...
	public void testConcat() throws Exception {
		...
		luaState.concat(2);
		Assert.assertEquals("ab", luaState.toString(1));
	...
	public void testGetTop() throws Exception {
		Assert.assertEquals(0, luaState.getTop());
		luaState.pushInteger(1);
		Assert.assertEquals(1, luaState.getTop());
		luaState.pushInteger(2);
		luaState.pushInteger(3);
		Assert.assertEquals(3, luaState.getTop());
	...
	public void testLen() throws Exception {
		...
		luaState.len(-1);
		Assert.assertEquals(3, luaState.toInteger(-1));
	...
	public void testNext() throws Exception {
		...
		Assert.assertEquals("key", luaState.toString(-2));
		Assert.assertEquals("value", luaState.toString(-1));
		luaState.pop(1);
	...
	public void testRaw() throws Exception {
		...
		luaState.pushInteger(1);
		luaState.rawGet(1);
		Assert.assertEquals(10.0, luaState.toNumber(-1), 0.0);
		luaState.pop(2);
		...
		luaState.rawSet(1, 1);
		luaState.rawGet(1, 1);
		Assert.assertEquals(20.0, luaState.toNumber(-1), 0.0);
		luaState.pop(2);
	...
	public void testField() throws Exception {
		...
		Assert.assertEquals("value2", luaState.toString(-1));
		luaState.pop(2);
	...
	public void testMetatable() throws Exception {
		...
		Assert.assertEquals(LuaType.TABLE, luaState.type(2));
		luaState.getField(2, "key");
		Assert.assertEquals("value", luaState.toString(3));
		luaState.pop(3);
	...
	public void testThread() throws Exception {
		...
		// Resume
		Assert.assertEquals(1, luaState.resume(1, 0));
		Assert.assertEquals(LuaState.YIELD, luaState.status(1));
		Assert.assertEquals(2, luaState.getTop());
		Assert.assertEquals(3, luaState.toInteger(-1));
		luaState.pop(1);
		...
		// Resume
		Assert.assertEquals(1, luaState.resume(1, 0));
		Assert.assertEquals(LuaState.OK, luaState.status(1));
		Assert.assertEquals(2, luaState.getTop());
		Assert.assertEquals(4, luaState.toInteger(-1));
		luaState.pop(1);
	...
	public void testReference() {
		...
		Assert.assertEquals("value", luaState.toString(2));
		luaState.pop(2);
	...
	public void testCheckByteArray() {
		...
		Assert.assertArrayEquals(new byte[1], luaState.checkByteArray(2, new byte[1]));
	...
	public void testCheckEnum() {
		...
		Assert.assertEquals(LuaState.RelOperator.EQ,
				luaState.checkEnum(1, LuaState.RelOperator.values()));
		Assert.assertEquals(LuaState.RelOperator.LT,
				luaState.checkEnum(2, LuaState.RelOperator.values(), LuaState.RelOperator.LT));
	...
	public void testCheckInteger() {
		luaState.pushInteger(1);
		Assert.assertEquals(1, luaState.checkInteger(1));
		Assert.assertEquals(2, luaState.checkInteger(2, 2));
	...
	public void testCheckNumber() {
		luaState.pushNumber(1.0);
		Assert.assertEquals(1.0, luaState.checkNumber(1), 0.0);
		Assert.assertEquals(2.0, luaState.checkNumber(2, 2.0), 0.0);
	...
	public void testCheckOption() {
		luaState.pushString("a");
		Assert.assertEquals(0, luaState.checkOption(1, new String[] { "a", "b" }));
		Assert.assertEquals(1, luaState.checkOption(2, new String[] { "a", "b" }, "b"));
	...
	public void testCheckMessage() {
		...
		assertNotNull(luaRuntimeException);
		assertEquals(
				"testCheckMessageFunction:1: ",
				luaRuntimeException.getMessage());
		assertEquals(
				"bad argument #3 to 'f' (msg)",
				luaRuntimeException.getCause().getMessage());
		assertEquals(3, luaRuntimeException.getLuaStackTrace().length);
		assertEquals(null, luaRuntimeException.getLuaStackTrace()[0].getFunctionName());
		assertEquals("[C]", luaRuntimeException.getLuaStackTrace()[0].getSourceName());
		assertEquals(-1, luaRuntimeException.getLuaStackTrace()[0].getLineNumber());

		assertEquals("f", luaRuntimeException.getLuaStackTrace()[1].getFunctionName());
		assertEquals(-1, luaRuntimeException.getLuaStackTrace()[1].getLineNumber());

		assertEquals("main", luaRuntimeException.getLuaStackTrace()[2].getFunctionName());
		assertEquals("testCheckMessageFunction", luaRuntimeException.getLuaStackTrace()[2].getSourceName());
		assertEquals(1, luaRuntimeException.getLuaStackTrace()[2].getLineNumber());
		...
		assertNotNull(luaRuntimeException);
		assertEquals(
				"testCheckMessageMethod:1: ",
				luaRuntimeException.getMessage());
		assertEquals(
				"bad argument #2 to 'm' (msg)",
				luaRuntimeException.getCause().getMessage());
		assertEquals(3, luaRuntimeException.getLuaStackTrace().length);
		assertEquals(null, luaRuntimeException.getLuaStackTrace()[0].getFunctionName());
		assertEquals("[C]", luaRuntimeException.getLuaStackTrace()[0].getSourceName());
		...
		assertEquals("m", luaRuntimeException.getLuaStackTrace()[1].getFunctionName());
		assertEquals("[C]", luaRuntimeException.getLuaStackTrace()[1].getSourceName());
		assertEquals(-1, luaRuntimeException.getLuaStackTrace()[1].getLineNumber());

		assertEquals("main", luaRuntimeException.getLuaStackTrace()[2].getFunctionName());
		assertEquals("testCheckMessageMethod", luaRuntimeException.getLuaStackTrace()[2].getSourceName());
		assertEquals(1, luaRuntimeException.getLuaStackTrace()[2].getLineNumber());
	...
	public void testCopyTable() {
		...
		while (luaState.next(1)) {
			...
			luaState.getTable(2);
			assertTrue(luaState.compare(-1, -2, LuaState.RelOperator.EQ));
			luaState.pop(2);
		}
