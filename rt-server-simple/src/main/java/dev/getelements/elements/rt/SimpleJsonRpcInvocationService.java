...
import dev.getelements.elements.rt.jrpc.*;
...
public class SimpleJsonRpcInvocationService implements JsonRpcInvocationService {
    ...
    private final LazyValue<JsonRpcManifest> jsonRpcManifest = new SimpleLazyValue<>(() -> getJsonRpcManifestService().getJsonRpcManifest());
