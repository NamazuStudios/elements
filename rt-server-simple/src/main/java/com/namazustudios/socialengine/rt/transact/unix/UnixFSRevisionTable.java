...
public class UnixFSRevisionTable implements AutoCloseable {
    ...
    private MappedByteBuffer loadRevisionTableFile(final Path revisionTableFilePath) throws IOException {
        ...
        try (final FileChannel channel = open(temporaryCopy, READ, WRITE)) {
            ...
            if (this.revisionTableCount < revisionTableCount) {
            ...
            } else if (this.revisionTableCount > revisionTableCount) {
                ...
                final int toAdd = this.revisionTableCount - revisionTableCount;
