...
import com.namazustudios.socialengine.rest.model.SmartContractPagination;
...
public class SuperUserSmartContractApiTest {
    ...
    public Object[] getTests() {
        return new Object[] {
                TestUtils.getInstance().getXodusTest(SuperUserSmartContractApiTest.class),
                TestUtils.getInstance().getUnixFSTest(SuperUserSmartContractApiTest.class)
        };
    }
