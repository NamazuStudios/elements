...
import static dev.getelements.elements.Constants.CORS_ALLOWED_ORIGINS;
import static dev.getelements.elements.Constants.DOC_OUTSIDE_URL;
import static dev.getelements.elements.Headers.*;
import static dev.getelements.elements.util.URIs.originFor;
