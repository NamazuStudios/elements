...
export async function registerRoutes(app: Express): Promise<Server> {
  // Note: Authentication is now handled directly by the client calling /api/rest/session
  // through the proxy in development mode or directly in production mode.
  // The client stores the session token and sends it via Elements-SessionSecret header.
