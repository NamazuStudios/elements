...
public class XodusResourceStores {
    ...
    public static final String PATHS = "com.namazustudios.socialengine.rt.xodus.paths";

    public static final String REVERSE_PATHS = "com.namazustudios.socialengine.rt.xodus.reverse.paths";

    public static final String RESOURCE_BLOCKS = "com.namazustudios.socialengine.rt.xodus.resource.blocks";
