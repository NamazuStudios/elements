...
import dev.getelements.elements.rt.transact.*;
...
public class XodusTransactionalResourceServicePersistenceEnvironment implements
    ...
    public static final String RESOURCE_ENVIRONMENT = "dev.getelements.elements.rt.xodus.resource";

    public static final String RESOURCE_ENVIRONMENT_PATH = "dev.getelements.elements.rt.xodus.environment.path";

    public static final String RESOURCE_BLOCK_SIZE = "dev.getelements.elements.rt.xodus.resource.block.size";
