...
import dev.getelements.elements.model.blockchain.wallet.CreateWalletRequestAccount;
...
public class TestNearSmartContractInvocationService {
    ...
    public Object[] getTests() {
        return new Object[] {
                TestUtils.getInstance().getXodusTest(TestNearSmartContractInvocationService.class),
    ...
    @Inject
    public void setUnderTest(@Unscoped NearSmartContractInvocationService underTest) {
