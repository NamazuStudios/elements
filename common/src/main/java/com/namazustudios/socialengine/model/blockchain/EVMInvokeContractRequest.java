...
public class EVMInvokeContractRequest {
    ...
    @ApiModelProperty("The input types for the method. Must correspond to valid ABI types.")
    private List<String> inputTypes;

    @ApiModelProperty("The parameters for the method.")
    private List<Object> parameters;

    @ApiModelProperty("The output types for the method. Must correspond to valid ABI types.")
