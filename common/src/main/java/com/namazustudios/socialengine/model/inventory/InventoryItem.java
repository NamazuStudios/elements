...
public class InventoryItem implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (getItem() != null ? !getItem().equals(inventoryItem.getItem()) : inventoryItem.getItem() != null)
            return false;
        return (getQuantity() != null ? !getQuantity().equals(inventoryItem.getQuantity()) : inventoryItem.getQuantity() != null);
    }
