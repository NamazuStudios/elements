...
function testInstanceOf ()
	...
	assert(java.instanceof(testObject, "com.namazustudios.socialengine.jnlua.test.fixture.TestObject"))
	assert(not java.instanceof(testObject, "java.lang.System"))
end

-- java.cast
function module.testCast ()
...
-- java.properties
function module.testProperties()
	local TestObject = java.require("com.namazustudios.socialengine.jnlua.test.fixture.TestObject")
	local testObject = java.new(TestObject)
	local properties = {}
	local count = 0	
