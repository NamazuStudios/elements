...
import dev.getelements.elements.rt.AsyncPublisher;
import dev.getelements.elements.rt.ConcurrentLockedPublisher;
...
import dev.getelements.elements.rt.remote.AsyncControlClient.Request;
...
import static dev.getelements.elements.rt.id.NodeId.forMasterNode;
...
public class JeroMQInstanceConnectionService implements InstanceConnectionService {
    ...
    public static final String JEROMQ_CLUSTER_BIND_ADDRESS =
        "dev.getelements.elements.rt.remote.jeromq.bind.addr";

    public static final String JEROMQ_CONNECTION_SERVICE_REFRESH_INTERVAL_SECONDS =
        "dev.getelements.elements.rt.remote.jeromq.connection.service.refresh.interval.sec";
