 ...
 */
@Expose({
    @ExposedModuleDefinition(value = "namazu.elements.service.scoped.item"),
    @ExposedModuleDefinition(value = "namazu.elements.service.unscoped.item", annotation = Unscoped.class)
})
