 ...
 */
@Expose({
    @ExposedModuleDefinition(value = "namazu.elements.service.scoped.gameon.prize"),
    @ExposedModuleDefinition(value = "namazu.elements.service.unscoped.gameon.prize", annotation = Unscoped.class)
})
