...
public class DefaultOidcSchemeConfiguration {
    ...
    private void createGoogleScheme() {
        ...
        final var scheme = getAuthSchemeService().findAuthScheme(issuer);
        ...
        try {
            getAuthSchemeService().createAuthScheme(request);
        } catch (Exception e) {
    ...
    private void createAppleScheme() {
        ...
        var request = new OidcAuthScheme();
        var keys = List.of(
        ...
        try {
            ...
            logger.debug("Apple OIDC Auth Scheme detected, skipping default...");
        }
    }
