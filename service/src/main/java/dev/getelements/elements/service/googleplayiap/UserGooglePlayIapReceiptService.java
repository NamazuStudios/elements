...
import static dev.getelements.elements.model.application.ConfigurationCategory.ANDROID_GOOGLE_PLAY;
...
import dev.getelements.elements.model.application.ProductBundleReward;
...
import static dev.getelements.elements.model.googleplayiapreceipt.GooglePlayIapReceipt.PURCHASE_STATE_CANCELED;
import static dev.getelements.elements.model.googleplayiapreceipt.GooglePlayIapReceipt.buildRewardIssuanceTags;
import static java.nio.charset.StandardCharsets.UTF_8;
import java.util.*;
import java.util.function.Supplier;

import static dev.getelements.elements.model.reward.RewardIssuance.GOOGLE_PLAY_IAP_SOURCE;
import static dev.getelements.elements.model.reward.RewardIssuance.Type.PERSISTENT;
import static dev.getelements.elements.model.reward.RewardIssuance.buildGooglePlayIapContextString;
