...
import dev.getelements.elements.dao.mongo.auth.MongoTotpLoginChallengeDao;
...
import dev.getelements.elements.dao.mongo.goods.MongoItemLedgerDao;
...
public class MongoDaoModule extends PrivateModule {
    ...
    protected void configure() {
        ...
        bind(TotpLoginChallengeDao.class).to(MongoTotpLoginChallengeDao.class);
        ...
        expose(TotpLoginChallengeDao.class);
