...
public class JacksonPaylaodWriterModule extends AbstractModule {

    private static final Logger logger = LoggerFactory.getLogger(JacksonPaylaodWriterModule.class);
