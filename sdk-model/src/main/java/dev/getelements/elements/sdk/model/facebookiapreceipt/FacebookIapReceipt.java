package dev.getelements.elements.sdk.model.facebookiapreceipt;
...
public class FacebookIapReceipt implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getSku(), that.getSku()) &&
                Objects.equals(getFbUserId(), that.getFbUserId()) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getFbUserId(), getPurchaseId(), getSku(), getGrantTime(), getExpirationTime(), getReportingId(), getDeveloperPayload());
    }
