...
public class UserCreateRequest implements Serializable {
    ...
    @Schema(description = "The user's level to assign. Depending on the usage, the server may ignore this field and " +
            "assign its own description.")
    private User.Level level;

    @Schema(description = "A list of profiles to assign to this user during creation. The server will attempt to create " +
