 ...
 * be configured partially by the container, therefore they should be created using a {@link jakarta.inject.Provider} or
 * {@link jakarta.inject.Inject}ed into client code.
 *
 * In general a new instance of {@link NotificationBuilder} should be obtained for each use as they should not be
 * considered thread-safe.   Likewise, they should not be bound in the container as {@link jakarta.inject.Singleton} types
