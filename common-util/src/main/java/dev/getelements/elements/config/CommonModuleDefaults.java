...
public class CommonModuleDefaults implements ModuleDefaults {
    ...
    public Properties get() {
        ...
        defaultProperties.setProperty(API_OUTSIDE_URL, "http://localhost:8081/api/rest");
        defaultProperties.setProperty(CORS_ALLOWED_ORIGINS, "http://localhost:8081,http://127.0.0.1:8081,http://localhost:4200,http://127.0.0.1:4200");
