    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        try {
            ...
            if (AUTH_TYPE_FACEBOOK.equals(authorizationHeader.getType())) {
                ...
                requestContext.setProperty(User.USER_ATTRIBUTE, facebookSession.getSession().getUser());
                requestContext.setProperty(Profile.PROFILE_ATTRIBUTE, facebookSession.getSession().getProfile());
                requestContext.setProperty(Application.APPLICATION_ATTRIUTE, facebookSession.getSession().getApplication());
